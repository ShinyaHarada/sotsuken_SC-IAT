  ...
  function TimelineNode(parameters, parent, relativeID) {
        ...
        if (timeline[current_location].advance()) {
          ...
          if (this.checkCompletion()) {
            ...
            while (
              ...
              timeline[current_location].checkCompletion()
            ) {
              current_location++;
            }
            if (this.checkCompletion()) {
    ...
    this.checkCompletion = function () {
      ...
      if (timeline.length > 0) {
        ...
        if (
          typeof conditional_function !== "undefined" &&
          current_location == 0
        ) {
...
jsPsych.pluginAPI = (function () {
  ...
  module.getKeyboardResponse = function (parameters) {
    ...
    var listener_function = function (e) {
      ...
      if (
        ...
        parameters.valid_responses.length === 0
      ) {
        valid_response = true;
      }
  ...
  var context =
    typeof window.AudioContext !== "undefined" ? new AudioContext() : null;
  var audio_buffers = [];
