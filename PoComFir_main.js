	...
	var intro =
	{
		...
		,text:         '<p class ="instructions">教示文:<br></br>この課題では、いくつかの単語が画面中央に提示されるので、キーの操作によって分類していただきます。'
    ...
    var instructions = 
	{
        ...
        ,text: '<p class ="left-side-begin">ポジティブ語<br>or</br>精神疾患のある人</p>'
				...
				+ '<br></br> 画面中央には上部のカテゴリーのいずれかに属する単語が次々と提示されます。左上のいずれかのカテゴリーに属する場合はFキー、右上のカテゴリーに属する場合はJキーを押してください。'
	...
	//var rev_full_trial_stimuli = jsPsych.randomization.repeat(im1,1);//最後にこの行を消す
